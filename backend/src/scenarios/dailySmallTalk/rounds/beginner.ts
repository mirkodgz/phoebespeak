    ...
    questions: [
      {
        ...
        question: (studentName: string) =>
          `How's your day going? Here is an answer you can use as a guide. Now why don't you try? 'It's going well, thanks. A little busy, but not too bad.' how your day is going.`,
      ...
      },
      {
        letter: 'B',
        question: (studentName: string) =>
          `Is this your first time here? Here is an answer you can use as a guide. Now why don't you try? 'Yes, it is. I wanted to try this place today.' if this is your first time here.`,
    ...
    questions: [
      {
        letter: 'A',
        question: (studentName: string) =>
          `What do you usually do on weekends? Here is an answer you can use as a guide. Now why don't you try? 'I usually relax, meet friends, or watch something at home.' what you usually do on weekends.`,
      ...
      },
      {
        letter: 'B',
        question: (studentName: string) =>
          `Have you seen any good movies or shows lately? Here is an answer you can use as a guide. Now why don't you try? 'Yes, I watched a nice movie last week. I really liked it.' about movies or shows you've seen.`,
      ...
      },
      {
        letter: 'C',
        question: (studentName: string) =>
          `Do you have any plans for later today? Here is an answer you can use as a guide. Now why don't you try? 'Nothing big. I might go for a walk or see a friend.' about your plans for later today.`,
    ...
    questions: [
      {
        letter: 'A',
        question: (studentName: string) =>
          `Sorry, am I interrupting? Here is an answer you can use as a guide. Now why don't you try? 'No, it's okay. I'm not very busy.' if I'm interrupting.`,
      ...
      },
      {
        letter: 'B',
        question: (studentName: string) =>
          `I'm not sure… have we met before? Here is an answer you can use as a guide. Now why don't you try? 'Maybe! I think we met once, but I'm not sure.' if we've met before.`,
