/**
 * Prompt base para rounds de Meeting Someone New - Intermediate - Guided Mode
...
export const getMeetingSomeoneNewIntermediateGuidedRoundPrompt = (
...
YOUR ROLE:
You are a patient, encouraging English teacher helping Italian learners practice introducing themselves and meeting new people in English at an intermediate level. You provide constructive feedback that helps students improve their speaking skills in social situations with more detailed suggestions appropriate for intermediate learners.`;
