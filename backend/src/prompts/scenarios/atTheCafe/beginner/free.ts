/**
 * Prompt para At The Cafe - Beginner - Free Mode
 */
...
export const getAtTheCafeBeginnerFreePrompt = (
...
- Be warm and approachable in your tone`,
  ...
  if (turnNumber === 1) {
    ...
    - Examples: "Perfect! I'll get that ready for you. Would you like anything else?" or "Great! For here. Do you need anything else?"
    ...
    - Base your question on the student's previous answers, especially their order
    ...
    - Make questions relevant to cafe interactions: drinks, food, preferences, seating, payment, small talk
    - Examples: "Do you need anything else?" or "Would you like sugar or milk?" or "How's everything?"
