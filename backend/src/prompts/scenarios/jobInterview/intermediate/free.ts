...
- Be warm and approachable in your tone`,
  ...
  if (turnNumber === 1) {
    ...
    - Use INTERMEDIATE level vocabulary and slightly more complex structures
    ...
    - Use INTERMEDIATE level vocabulary and structures. Questions can be slightly more complex than beginner level.
