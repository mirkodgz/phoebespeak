/**
 * Prompt para Job Interview - Intermediate - Free Mode
 */
...
export const getJobInterviewIntermediateFreePrompt = (
...
- Keep questions clear and appropriate for INTERMEDIATE level
- You can use slightly more complex vocabulary and longer sentences
- After 8-10 questions, provide a closing message`,
  );

  // Similar structure to beginner but with intermediate-level adaptations
  ...
  if (turnNumber === 1) {
    ...
    Make this first question relevant to the specific position and company. Use INTERMEDIATE level vocabulary and slightly more complex structures.`;
  } else {
    const lastUserMessage = context.conversationHistory
      .slice()
      .reverse()
    ...
    IMPORTANT: Use INTERMEDIATE level vocabulary and structures. Questions can be slightly more complex than beginner level.
