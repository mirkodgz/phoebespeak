...
- Be warm and approachable in your tone`,
  ...
  if (turnNumber === 1) {
    ...
    RESPONSE FORMAT (JSON):
    {
      "tutorMessage": "Perfect! I'll help you practice an interview for ${company} as a ${position}. Let's begin! [Your first interview question here]",
      "question": "Perfect! I'll help you practice an interview for ${company} as a ${position}. Let's begin! [Your first interview question here]",
      "feedback": null,
      "shouldEnd": false
    }`;
    ...
    RESPONSE FORMAT (JSON):
    {
      "tutorMessage": "Great job! This completes our practice interview. If you want, we can repeat it or try a different role play.",
      "question": "Great job! This completes our practice interview. If you want, we can repeat it or try a different role play.",
      "feedback": null,
      "shouldEnd": true,
      "closingMessage": "Great job! This completes our practice interview. If you want, we can repeat it or try a different role play."
    }`;
  }
