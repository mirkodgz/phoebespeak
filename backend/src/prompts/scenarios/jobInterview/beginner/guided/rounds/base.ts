/**
 * Prompt base para rounds de Job Interview - Beginner - Guided Mode
...
export const getJobInterviewBeginnerGuidedRoundPrompt = (
...
- Be specific: Instead of "good job", say exactly what was good (e.g., "You pronounced 'experience' correctly")
- Make pronunciation tips clear: Use phonetic notation AND explain in simple English (e.g., "pronounce 'think' /θɪŋk/ with the 'th' sound /θ/ like when you blow air")
